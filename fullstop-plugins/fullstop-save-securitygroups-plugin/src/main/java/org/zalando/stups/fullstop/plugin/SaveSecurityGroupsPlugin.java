...
public class SaveSecurityGroupsPlugin extends AbstractFullstopPlugin {
    ...
    private void writeToS3(final String content, final String prefix, final String instanceId) {
    ...
    private List<String> listS3Objects(final String buckestName, final String prefix) {
