 ...
 * Created by mrandi.
 */
public class ELBHttpCall implements Callable<Boolean> {

    private final Logger log = LoggerFactory.getLogger(ELBHttpCall.class);
    ...
    public ELBHttpCall(CloseableHttpClient httpclient, LoadBalancerDescription loadBalancerDescription,
            Integer allowedPort) {
